...
```java
public class PratyaAmrit extends Developer {
    ...
    String funFact() {
        return "I play games when I'm not writing code 🎮";
    }
}
```
...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>📦 <a href="https://github.com/Pratya-Amrit1/Todo-microservices">Todo Microservices</a></h3>
      <p>A microservices-based Todo application demonstrating <strong>distributed architecture</strong> patterns with independent services and JavaScript.</p>
      <img src="https://img.shields.io/badge/JavaScript-yellow?style=flat-square&logo=javascript&logoColor=black"/>
    </td>
    <td width="50%" valign="top">
      <h3>☁️ <a href="https://github.com/Pratya-Amrit1/Weather-Prediction-using-Machine-Learning-Python--main">Weather ML Predictor</a></h3>
      <p>Weather forecasting using <strong>Machine Learning in Python</strong>. Data analysis pipelines, feature engineering, and predictive model training in Jupyter Notebooks.</p>
      <img src="https://img.shields.io/badge/Jupyter_Notebook-Python-F37626?style=flat-square"/>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>⚡ <a href="https://github.com/Pratya-Amrit1/leetcode">LeetCode Grind</a></h3>
      <p>Daily LeetCode solutions in <strong>Java</strong> — consistent practice tracking DSA patterns, problem-solving techniques, and competitive programming growth.</p>
      <img src="https://img.shields.io/badge/Java-DSA-ED8B00?style=flat-square"/>
      <img src="https://img.shields.io/github/stars/Pratya-Amrit1/leetcode?style=flat-square"/>
    </td>
    <td width="50%" valign="top">
      <h3>🎮 <a href="https://github.com/Pratya-Amrit1/pokemon-app">Pokémon App</a></h3>
      <p>A <strong>React-powered</strong> Pokédex explorer with REST API integration, component-based architecture, and interactive state management.</p>
      <img src="https://img.shields.io/badge/React-JavaScript-61DAFB?style=flat-square"/>
    </td>
  </tr>
</table>
...
[![Email](https://img.shields.io/badge/Email-Say%20Hi-EA4335?style=for-the-badge&logo=gmail)](mailto:pratya192@gmail.com)
